execute as @a[nbt={SelectedItem:{id:"minecraft:stick",Count:1b,tag:{sniper:1b}}}] run item replace entity @s weapon.offhand with minecraft:carrot_on_a_stick{display:{Name:'{"text":"Paintball Sniper magazine","color":"light_blue","bold":false,"italic":false}'},Unbreakable:1b,sniper:1b,CustomModelData:421}
